...
<html lang="en-us" class="no-js">
	...
	<head>
		<meta charset="utf-8">
        <title>JustMedia</title>
        <meta name="description" content="JustMedia is a Media Production company ran by Chloe Malpas & Lewis Gazzard. We provide services ranging from Web Design, to Video Production.">
...
<a id="bgndVideo" class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=7Nj6V7i3US0',containment:'body',autoPlay:true, mute:false, startAt:0, stopAt:0, opacity:1, loop:true}"></a>
	<body>
...
<div class="global-overlay">
			...
			<!--	<div id="vegas-background"></div>-->
				...
				<div class="content">
					...
					<h1 class="text-intro opacity-0">JustMedia</h1>



					<p class="text-intro opacity-0">Creative Design</p>
<!-- FIDGET SPINNER!!!!!! -->
...
<!--END OF FIDGET SPINNER-->
					<nav>
						<ul>
							<li>
								<a href="#" id="open-more-info" data-target="right-side" class="action-btn text-intro opacity-0">See our work.</a>
							</li>
				<!--	<li>
								<a href="http://www.portal.justmedia.ml">Client Portal</a>
							</li> -->
						</ul>
					</nav>
				...
				<div class="bottom-home">
					...
					<div class="social-icons">
						...
						<a href="http://www.facebook.com/justmedia17"><i class="fa fa-facebook"></i></a>
						<a href="http://portal.justmedia.ml"><i class="fa fa-tachometer"></i></a>
					...
					<p class="copyright">
						...
						<strong>  © JustMedia - Created & Powered by Chloe & Lewis.</strong> (Mostly Lewis, and Chloe.)
		...
		<section id="right-side" class="hide-right">
			...
			<div class="content">
				...
				<h2>JustMedia, high-quality media production.</h2>

				<p>JustMedia was founded by Chloe Malpas & Lewis Gazzard, in Mid-2017. We work together, to produce promo videos, websites, branding & much more, to make you stand out on an online world.</p>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-lg-6 box-info">
						<div class="box-info-light equalizer">
							...
							<span class="icon icon-clock"><i class="icon ion-settings"></i></span>

							<h3>Current Project: Bristol Cinematic </h3>

							<p>Title says all, we're creating a cinematic video, similar to our London video, for Bristol.

							We are releasing this film on the 24th December.</p>
			...
			<!--		<div class="col-xs-12 col-sm-12 col-lg-6 box-info">
						<div class="box-info-light equalizer">
							...
							<h3>Next Film Releasing in : <div id="getting-started"></div></h3>

							<p>Our next film is a promotional video for Off The Record, a mental health company for young people, suffering from Mental Illnesses.</p>
					...
					<div class="col-xs-12 col-sm-12 col-lg-6 box-info">
						<div class="box-info-dark equalizer">
							...
							<span class="icon"><i class="icon ion-ios-film-outline"></i></span>

							<h3 class="text-uppercase color-grey">Current Client</h3>

							<p>We are currently working with Workout Bristol, to produce the Craig Stevens Show. This is a podcast about sport & fitness,
							witch is released onto YouTube, iTunes & Stitcher. </p>
				...
				<div class="photo-line">
					...
					<div class="my-gallery row" itemscope itemtype="http://schema.org/ImageGallery">
						...
						<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-xs-12 col-sm-6 col-lg-6">
							...
							<a class="box-picture" href="https://www.youtube.com/channel/UCEkR_ZZJIGVR2plB4R9Q8aA" itemprop="contentUrl" data-size="1920x1280">

								<!-- Your picture -->
								<img src="img/craig.jpg" itemprop="thumbnail" alt="This is my work" class="img-responsive" />
							...
							<figcaption itemprop="caption description">
								...
								<div class="photo-details">
									...
									<h4>Craig Stevens Show</h4>

									<h5>Workout Bristol</h5>

									<p>We are working with Workout Bristol, to produce their new series of the Craig Stevens Show, a weekly podcast
									 based around fitness, and entrepreneurship in sports.</p>
						...
						<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-xs-12 col-sm-6 col-lg-6">
							...
							<!-- Link to the picture and to open the gallery / Fill up well the data-size property -->
							<a class="box-picture" href="https://www.youtube.com/watch?v=7Nj6V7i3US0" itemprop="contentUrl" data-size="1920x1280">
							...
							<figcaption itemprop="caption description">
								...
								<div class="photo-details">
									...
									<h4>London Cinematic</h4>

									<h5>United Kingdom (Whoop!)</h5>

									<p>This film was the result of us being bored in London. One of our favourite videos, and our most viewed.</p>
					...
					<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-xs-12 col-sm-6 col-lg-6">
							...
							<!-- Link to the picture and to open the gallery / Fill up well the data-size property -->
						<a class="box-picture" href="https://www.youtube.com/watch?v=mgAnfDasfb4" itemprop="contentUrl" data-size="1920x1280">

								<!-- Your picture -->
						<img src="https://cdn.escapismmagazine.com/gallery/58c677be7b999.jpeg" itemprop="thumbnail" alt="This is my work" class="img-responsive" />
													<p>Heritage Heresy</p>
					...
					<figcaption itemprop="caption description">
								...
								<div class="photo-details">
									...
									<h4>Heritage Heresy</h4>

									<h5>Bath</h5>

									<p><strong>If rules are made to be broken, why doesn’t anyone ever break the rules in Bath? </strong>
				...
				<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-xs-12 col-sm-6 col-lg-6">
							...
							<!-- Link to the picture and to open the gallery / Fill up well the data-size property -->
						<a class="box-picture" href="https://www.youtube.com/watch?v=1zYQnxuJto4" itemprop="contentUrl" data-size="1920x1280">
					...
					<figcaption itemprop="caption description">
								...
								<div class="photo-details">
									...
									<p>UpFest is one of Europe's largest street art festivals. We attended in 2017, and created this.</p>
				...
				<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-xs-12 col-sm-6 col-lg-6">
							...
							<!-- Link to the picture and to open the gallery / Fill up well the data-size property -->
				<a class="box-picture" href="https://www.youtube.com/watch?v=GlC45Ok3g_g" itemprop="contentUrl" data-size="1920x1280">

								<!-- Your picture -->
						<img src="img/wow.jpg" itemprop="thumbnail" alt="This is my work" class="img-responsive" />
								</span>
								<p>Warriors of Wellbeing</p>
							...
							<figcaption itemprop="caption description">
								...
								<div class="photo-details">
									...
									<h4>Warriors of Wellbeing</h4>

									<h5>Clevedon</h5>

									<p> This Film was a promotional video for the Warriors of Wellbeing event in Clevedon, on World
											Mental Health Day. The film shows how people come together, and shows that Mental Health is becoming less
										stigmatised in society, as events like this are accepted, and that they do help change peoples views
									on people with mental illnesses.</p>
	...
	<!--						<figcaption itemprop="caption description">
				...
				<p>We are here to help you <strong>Monday through Sunday</strong>, from 9:00 AM to 10:00 PM.<br>
					You can also give us a call at <a href="tel:07870352477" class="phone-mail-link">07870352477</a> and speak with us.
				</p>
			...
			<!--	<h4>OPAL’s Business Concept info.</h4>
				...
				<p>
					<i class="icon ion-ios-telephone"></i> <strong>Phone :</strong> (+44) 7870352477 <br>
					<i class="icon ion-ios-email"></i> <strong>Email :</strong> <a href="mailto:hello@justmedia.ml" class="phone-mail-link">justmedia2017@gmail.com</a> <br>
					<i class="icon ion-ios-location"></i> <strong>Location :</strong> Bristol, United Kingdom.
				</p>
		...
		<div id="somedialog" class="dialog">
			...
			<div class="dialog__content">
				...
				<div class="dialog-inner">
					...
					<p>Being the first to know always feels great... Signing up to our newsletter gives you <strong>exclusive access to unreleased films, see them before anyone else!</strong></p>
...
<script src="js/vegas-youtube-mobile.js"></script> -->
		...
		$("#getting-started")
			...
			.countdown("2017/10/16 12:00:00", function(event) {
				$(this).html(
	...
	<!---	<script>
		$(window).load(function() {
			$(function($){
				$('body').vidbg({
						'mp4': 'media/london.mp4', // Link to your video
						'poster': 'img/gallery-1.jpg', // Picture displayed on mobile
					}, {
